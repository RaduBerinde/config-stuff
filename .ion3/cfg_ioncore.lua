...
defbindings("WScreen", {
    ...
    --kpress(ALTMETA.."F11", "mod_query.query_menu(_, _sub, 'mainmenu', 'Main menu:')"),
...
defbindings("WClientWin", {
    ...
    submap(META.."W", {
        ...
        kpress_wait(META.."R", "WClientWin.nudge(_)"),
...
defbindings("WMPlex.toplevel", {
    ...
    kpress(ALTMETA.."F1", "ioncore.exec_on(_, XTERM or 'xterm')"),

    kpress(ALTMETA.."F2", "ioncore.exec_on(_, XTERM_DEVASK)"),
    ...
    kpress(ALTMETA.."F12", "ioncore.restart()")
})
...
defbindings("WFrame.toplevel", {
    ...
    submap(META.."W", {
        ...
        kpress("0", "ioncore.tabnum.show(_)"),
...
defmenu("mainmenu", {
    ...
    menuentry("rberinde-linux", "ioncore.exec_on(_, XTERM_DEVBOX)"),
    menuentry("vmc-dbc301",     "ioncore.exec_on(_, XTERM_VMC_DBC)"),
    menuentry("pa-dbc1109",     "ioncore.exec_on(_, XTERM_PA_DBC)"),
    menuentry("rberinde-hbrsrv","ioncore.exec_on(_, XTERM_HBRSRV)"),
